...
import signupImage from "../../UI/image/log.png";
          ...
          <div className="w-full lg:w-1/2 px-8 py-10">
            ...
            <form onSubmit={handleSignUp} className="space-y-4">
              ...
              <div>
                <button
                  type="submit"
                  className="w-full py-3 px-6 bg-gradient-to-r bg-blue-900  text-white font-semibold rounded-lg shadow-lg hover:from-sky-900 hover:to-sky-900 focus:outline-none focus:ring-4 focus:ring-sky-500 transition duration-200 ease-in-out transform hover:scale-105"
                >
                  Sign Up
                </button>
              </div>
